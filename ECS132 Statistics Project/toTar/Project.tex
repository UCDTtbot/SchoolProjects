...
%d
    ...
    %Possibly important to add that significance testing may not be that great of a thing
...
\addcontentsline{toc}{subsection}{Introduction to Modeling Wordbank Data}
%INTRODUCTION
...
\addcontentsline{toc}{subsection}{Vocabulary and Age}
...
\addcontentsline{toc}{subsection}{Vocabulary and Ethnicity}
...
\addcontentsline{toc}{subsection}{Vocabulary and Sex}
...
\addcontentsline{toc}{subsection}{Vocabulary and Mother's Education}
...
\addcontentsline{toc}{subsection}{Vocabulary and Order of Birth}
...
\begin{itemize}
    ...
    \label{sec:BOV}
    \item BirthOrderVocab() is designed to explore the relationship between the birth order and child's vocabulary size. The function finds the mean, standard deviation, standard error, and 95\% confidence interval for vocabulary for each birth order, then finds the linear regression model and plots it.
    \begin{lstlisting}[basicstyle=\small]
